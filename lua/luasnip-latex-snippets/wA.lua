...
function M.retrieve(not_math)
  ...
  return {
    ...
    parse_snippet({ trig = "bff", name = "Bold Text" }, "\\textbf{${1:${TM_SELECTED_TEXT}}}$0"),
    parse_snippet({ trig = "itt", name = "Bold Text" }, "\\textit{${1:${TM_SELECTED_TEXT}}}$0"),
    parse_snippet({ trig = "bfit", name = "Bold Text" }, "\\textbfit{${1:${TM_SELECTED_TEXT}}}$0"),
    parse_snippet({ trig = "sff", name = "Sans Serif Text" }, "\\textsf{${1:${TM_SELECTED_TEXT}}}$0"),
