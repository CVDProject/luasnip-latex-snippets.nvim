...
function M.retrieve(is_math)
  ...
  return {
    ...
    parse_snippet({ trig = "l..", name = "ddots" }, "\\ldots "),
    ...
    parse_snippet({ trig = "msf", name = "mathsf" }, "\\symrm{$1}$0"),
    ...
    parse_snippet({ trig = "<n=", name = "lneq", priority = 100 }, "\\lne "),
    parse_snippet({ trig = ">n=", name = "gneq", priority = 100 }, "\\gne "),
    parse_snippet({ trig = "prec", name = "preceq", priority = 100 }, "\\gne "),
    parse_snippet({ trig = "suc", name = "succeq", priority = 100 }, "\\gne "),
    ...
    parse_snippet({ trig = "@vf", name = "phi" }, "\\phi "),
