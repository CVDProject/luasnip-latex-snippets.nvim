...
local postfix_completions = function()
  local re = "sin|cos|tan|csc|sec|cot|sinh|cosh|tanh|coth|csch|sech|exp|ln|log|star|perp|det|Tr|diag|rank|rk|det|dim|dom|ker|img|Im|Re|arg|inf|sup|min|max|sgn|char|land|lor"
