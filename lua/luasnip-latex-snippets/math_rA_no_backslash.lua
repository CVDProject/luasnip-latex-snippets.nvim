...
local postfix_completions = function()
  local re = "sin|cos|tan|csc|sec|cot|sinh|cosh|tanh|coth|csch|sech|ln|log|exp|star|perp|ker|det|inf|sup|Tr|diag|rank|det|dim|ker|Im|Re|arg|min|max|sgn|OPT|land|lor"
