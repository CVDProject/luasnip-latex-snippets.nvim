...
local postfix_completions = function()
  local re = "id|sin|cos|tan|csc|sec|cot|sinh|cosh|tanh|coth|csch|sech|exp|ln|log|star|perp|deg|det|tr|diag|rank|rk|det|dim|Obj|Hom|dom|ker|img|Im|Re|arg|inf|sup|min|max|sgn|wedge|vee"
